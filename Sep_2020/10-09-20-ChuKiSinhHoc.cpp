/*
* A program to determine your biological cycle.
* 
* Method: find number of days from your birthday.
*
* PL_small_problems#08, last update: 17.07.23
*/
...
int main(int argc, char *argv[])
{
	...
	// tinh cac chu ki va doi ra phan tram
