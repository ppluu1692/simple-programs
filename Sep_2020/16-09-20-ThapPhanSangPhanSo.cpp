/*
* A program to convert a decimal number to an irreducible fraction.
* 
*       _____   ____
* Idea: xy.zt = xyzt / 100
*       _____   ___
*       0.xyz = xyz / 999
*
* PL_small_problems#14, last update: 17.07.23
*/
...
{	
	...
	cout << s << " --> " << tsnguyen<<'/'<<setprecision(12)<<mauchung<< endl;
